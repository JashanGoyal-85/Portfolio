          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-3/5 animate-fadeIn">
            ...
            <div className="text-lg md:text-xl lg:text-2xl text-gray-300 leading-8 mb-6 animate-fadeIn">
              <div className="flex flex-col gap-2">
                {/* The Large Title */}
                <VariableProximity
                  label="Competitive Programmer & Full-Stack   Developer"
                  className="text-2xl font-extrabold text-white variable-proximity"
                ...
                <VariableProximity
                  label="Passionate problem-solver with 1200+ DSA problems conquered. Skilled in building dynamic, efficient web applications with React, Next.js, and Node.js."
                  className="text-xl text-gray-300 variable-proximity"
                  fromFontVariationSettings="'wght' 400, 'opsz' 9"
                  toFontVariationSettings="'wght' 700, 'opsz' 40"
                  containerRef={containerRef}
                  radius={120}
            ...
            <div className="flex justify-center md:justify-start gap-4 animate-fadeIn">
              <a
                href="https://drive.google.com/file/d/1d9ALAgqR8nv9rUy-vGRJV8RBR5E19Kop/view?usp=drive_link"
                target="_blank"
